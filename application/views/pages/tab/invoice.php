...
<form id="formSearchSO" method="post" action="<?php echo site_url('pages/invoice'.(isset($segment)? '/'.$segment:'')); ?>">
    <div class="col-md-7">
      <div class="row">
        <div class="col-md-5">
        </div>
...
<div class="row">
  <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-md-6">
                <label>Invoice Count<?php echo ($si_num_rows>1?'s':''); ?>: <?php echo $si_num_rows; ?></label>
            </div>
            <div class="col-md-6">
                <div align="right">
