								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
											...
											<form action="<?php echo site_url('auth/login'); ?>" method="POST">
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="button" onclick="$('form').submit(); return false;" class="width-35 pull-right btn btn-sm btn-primary">
										...
										<div class="toolbar clearfix">
											...
											<?php if($num_rows==0): ?>
											<div>
												<a href="<?php echo site_url('pages/create_account'); ?>" data-target="#signup-box" class="user-signup-link">
													I want to register
