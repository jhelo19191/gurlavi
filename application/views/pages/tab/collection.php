...
<form id="formSearchSO" method="post" action="<?php echo site_url('pages/collection'.(isset($segment)? '/'.$segment:'')); ?>">
    <div class="col-md-7">
      <div class="row">
        <div class="col-md-5">
        </div>
...
<div class="row">
  <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-md-6">
                <label>Collection Count<?php echo ($collect_count>1?'s':''); ?>: <?php echo $collect_count; ?></label>
            </div>
            <div class="col-md-6">
                <div align="right">
