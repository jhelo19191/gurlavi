...
<form action="<?php echo site_url('remittance/insert/'.$sales_order_id.'/request'); ?>" method="post" class="form-submit" enctype="multipart/form-data">
        ...
        <div class="col-sm-10 col-sm-offset-1">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" onkeypress="return isNumber(event);" value="<?php echo (isset($remittance_no)?$remittance_no:'') ?>" name="remittance_number" />
                </div>
                <div class="col-md-6">
                    <label>Remittance Date:</label>
                    <input type="text" class="form-control date-picker" value="<?php echo (isset($remittance_date)?$remittance_date:'') ?>" readonly name="remittance_date" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-10 col-sm-offset-1">
        <div class="widget-toolbar no-border invoice-info" style="float: left;">
            <span>Remittance No:</span>
                <span class="red">#<?php echo (isset($remittance_no)?$remittance_no:'Not Available'); ?></span>

            <br />
            <span>Remittance Date:</span>
                <span class="blue"><?php echo (isset($remittance_date)?date('m/d/Y', strtotime($remittance_date)):'Not Available'); ?></span>
        </div>
    </div>
</div>
        ...
        <div class="widget-box transparent">
            ...
            <div class="widget-body">
                <div class="widget-main padding-24">
                    ...
                    <!--            <h4><i class="fa fa-upload"></i> Upload the remittance form with sign:</h4>-->
                    <!--            <input multiple="" name="files_uploads" class="upload-images" type="file" id="id-input-file-3" />-->
                    <!--        </div>-->
                    <!--    </div>-->
                    <!--</div>-->
                    <div class="hr dotted"></div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <h4><i class="fa fa-upload"></i> Upload the remittance form with sign:</h4>
                                <input name="files_uploads" class="upload-images" type="file" id="id-input-file-3" />
                            </div>
                        </div>
                    </div>
                    <div class="hr dotted"></div>
                    ...
                    <div class="row">
                        <div class="col-md-12" align="right">
                            <a href="<?php echo site_url('pages/remittance'); ?>" class="btn btn-info"><i class="fa fa-angle-left"></i> Back</a>
                            <button onclick="$('.form-submit').submit(); return false;" class="btn btn-primary submit-remittance"><i class="fa fa-save"></i> Save</button>
                        </div>
                    </div>
                    <?php else: ?>
                    <div class="row">
      ...
      <div class="modal-body">
        <form id="statusRecord">
            ...
            <div class="container-message">
                <div class="form-group">
                   <i class="fa fa-comment"></i> <label>Comments</label>
...
<script>
    $(function(){
        ...
        $('.submit-remittance').on('click',function(){
