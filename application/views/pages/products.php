<div class="row">
  <div class="col-md-5">
    <a href="<?php echo site_url('products/index'); ?>" class="btn btn-primary" /><i class="fa fa-plus"></i> New Product</a>
    <button class="btn btn-primary" id="upload-products"><i class="fa fa-upload"></i> Upload Products</button>
  </div>
  <div class="col-md-7">
    <div class="row">
      <div class="col-md-5">
      ...
      <div class="col-md-7">
        <form id="product-search" action="<?php echo site_url('pages/products'); ?>" method="post">
...
<div class="row">
    <div class="col-md-6">
        <label>Record Count<?php echo ($record_counts>1?'s':''); ?>: <?php echo $record_counts; ?></label>
    </div>
    <div class="col-md-6">
        <div align="right">
...
<!-- Modal -->
<div id="uploadProducts" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><i class="fa fa-upload"></i> Upload Products</h4>
            </div>
...
<script>
    $(function(){
        ...
        $('#upload-products').on('click',function(){
            var _modal_upload = $('#uploadProducts');
