...
<script>
    $(function(){
        ...
        $('.show-view').on('click',function(){
            ...
            _activity(_payment_type,_dtc,_tid,'view');
            
            return false;
        });
        
        
        var _activity = function activity(_payment_type,_dtc,$tid,$activity_type){
            $.ajax({
                type:'POST',
                url:main_path+'/generate/'+$activity_type,
                dataType:'json',
                data:{'payment_type':_payment_type,'dtc':_dtc,'tid':$tid,'activity':$activity_type},
                success:function(data){
