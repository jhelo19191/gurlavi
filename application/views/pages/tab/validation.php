...
<form id="formSearchSO" method="post" action="<?php echo site_url('pages/validation'.(isset($segment)? '/'.$segment:'')); ?>">
    <div class="col-md-7">
      <div class="row">
        <div class="col-md-5">
        </div>
...
<div class="row">
  <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-md-6">
                <label>Request Count<?php echo ($validation_count>1?'s':''); ?>: <?php echo $validation_count; ?></label>
            </div>
            <div class="col-md-6">
                <div align="right">
