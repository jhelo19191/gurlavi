...
class RcollectionModel extends CI_Model
{
    ...
    public function fetch_collection($tbName,$start,$limit,$search,$type_ordering)
    {
        ...
        $this->db->where($this->_sales_order.'.status', 3);
    ...
    public function countSalesOrder($search)
    {
        ...
        $this->db->join($this->_cash_info,$this->_cash_info.'.sales_order_id='.$this->_sales_order.'.sales_order_id');
        $this->db->join($this->_pdc_info,$this->_pdc_info.'.sales_order_id='.$this->_sales_order.'.sales_order_id');
        $this->db->join($this->_credit_card_info,$this->_credit_card_info.'.sales_order_id='.$this->_sales_order.'.sales_order_id');
    ...
    public function insertCollection($sales_order_id,$collection_no,$collection_date,$message)
    {
        $data = array(
                        'sales_order_id' => $sales_order_id,
                        'cr_no' => $collection_no,
